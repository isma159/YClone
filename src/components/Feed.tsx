...
export function Feed({posts, users, setSelectedPost, onDeletePost}: {posts: Posts, users: Users, setSelectedPost: (selectedPost: ExtendedPost | null) => voi, onDeletePost: (id:number) => voidd}) {
    return (
